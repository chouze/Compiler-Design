...
public final class AArrayNewNonterminal extends PNewNonterminal
{
    private TInt _int_;
    ...
    public Object clone()
    {
        return new AArrayNewNonterminal(
    ...
    {
        ((Analysis) sw).caseAArrayNewNonterminal(this);
    }
