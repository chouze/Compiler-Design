...
public final class AFactorNotnonterminal extends PNotnonterminal
{
    private PFactor _factor_;
    private final LinkedList<PDotarray> _dotarray_ = new LinkedList<PDotarray>();

    public AFactorNotnonterminal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFactorNotnonterminal(
    ...
    {
        ((Analysis) sw).caseAFactorNotnonterminal(this);
    }
