...
public final class AIdentifierNewterminal extends PNewterminal
{
    private TIdentifier _identifier_;
    private TLeftParen _leftParen_;
    private TRightParen _rightParen_;

    public AIdentifierNewterminal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIdentifierNewterminal(
    ...
    {
        ((Analysis) sw).caseAIdentifierNewterminal(this);
    }
